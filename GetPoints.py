...
if __name__=='__main__':
    ...
    profile.run('print draw_circle_bi_search2(1000000)')   
    profile.run('print draw_circle_bi_search(1000000)')   
    profile.run('print draw_circle_advanced_search(1000000)')